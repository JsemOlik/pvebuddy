...
struct VmUsageGraphsView: View {
    let chartPoints: [VMDetailViewModel.ChartPoint]
    
    private var recentPoints: [VMDetailViewModel.ChartPoint] {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                if recentPoints.isEmpty {
                    VStack(spacing: 8) {
                        ...
                        Text("Data will appear as the VM runs")
                            .font(.caption2)
                            .foregroundStyle(.secondary)
                    }
                    .frame(height: 120)
